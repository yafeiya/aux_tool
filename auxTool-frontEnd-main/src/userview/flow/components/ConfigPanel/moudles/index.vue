  ...
  <Tabs class="config" value="1">
    <TabPane label="超参数" name="1">
      ...
      <Row class="params" align="middle">
        ...
        <Col :span="14">
          <Input
            v-model="data.Network_num"
            style="width: 100%"
            placeholder="default 256"
            @change="onNetwork_numChange"
          />
        </Col>
      </Row>
      <Row class="params" align="middle">
      ...
      <Row class="params" align="middle">
        ...
        <Col :span="14">
          <Input
            v-model="data.Optimizer"
            style="width: 100%"
            placeholder="default SGD"
      ...
      <Row class="params" align="middle">
        ...
        <Col :span="14">
          <Input
            v-model="data.Epoch_num"
            style="width: 100%"
            placeholder="default 10000"
            @change="onEpoch_numChange"
          />
        </Col>
      </Row>
      <Row class="params" align="middle">
      ...
      <Row class="params" align="middle">
        ...
        <Col :span="14">
          <Input
            v-model="data.Act_function"
            style="width: 100%"
            placeholder="default RELU"
            @change="onAct_functionChange"
          />
        </Col>
      </Row>
      <Row class="params" align="middle">
        ...
        <Col :span="14">
          <Input
            v-model="data.Decay_factor"
            style="width: 100%"
            placeholder="default 0.95"
            @change="onDecay_factorChange"
          />
        </Col>
      </Row>
      <Row class="params" align="middle">
        ...
        <Col :span="14">
          <Input
            v-model="data.Explore_rate"
            style="width: 100%"
            placeholder="default 0.9"
            @change="onExplore_rateChange"
          />
        </Col>
      </Row>
      <Row class="params" align="middle">
        ...
        <Col :span="14">
          <Input
            v-model="data.Radom_seed"
            style="width: 100%"
            placeholder="default 42"
            @change="onRadom_seedChange"
          />
        </Col>
      </Row>
    </TabPane>
