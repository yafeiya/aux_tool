...
-- ----------------------------
INSERT INTO `datatable` VALUES (73, '数值数据集', '任务1', '123', '888.csv', 4, 56, 'float', '数值数据集/任务1/33/888.csv', '1697360644668');
INSERT INTO `datatable` VALUES (78, '数值数据集', '任务1', '22', '444.csv', 4, 56, 'float', '数值数据集/任务1/33/444.csv', '1697365482093');
INSERT INTO `datatable` VALUES (80, '数值数据集', '任务1', '33', '111.csv', 4, 56, 'float', '数值数据集/任务1/33/111.csv', '1698133150550');
INSERT INTO `datatable` VALUES (82, '数值数据集', '任务1', '42', '444.csv', 4, 56, 'float', '数值数据集/任务1/42/444.csv', '1720684332348');
INSERT INTO `datatable` VALUES (83, '数值数据集', '任务1', '33', '444.csv', 4, 56, 'float', '数值数据集/任务1/33/444.csv', '1720686862195');
...
INSERT INTO `example` VALUES (33, 'test2', '', '运行中', 4, 1, 0, '', '', '200e', '', 'loss', 'optimizer', 'decay', 'evaluation', 'model_url', '2000M', 1720772595299, 0);
INSERT INTO `example` VALUES (35, 'test1', '', '运行中', 4, 1, 0, '', '', '200e', '', 'loss', 'optimizer', 'decay', 'evaluation', 'model_url', '2000M', 1721297038522, 0);
