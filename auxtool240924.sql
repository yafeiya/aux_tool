...
INSERT INTO `database` VALUES (33,'11','百万数据集','数值数据集','2级','2','有','./任务1/数值数据集/百万数据集/','2','任务1'),(42,'11','小样本数据','数值数据集','3级','22','有','./任务1/数值数据集/小样本数据/','2','任务1'),(44,'11','1012','数值数据集','3级','11','有','./任务2/数值数据集/1012/','11','任务2'),(45,'11','车辆数据','图像数据集','2级','int,png,jpg','有','./自然图像/图像数据集/车辆数据/','车辆检测数据集','自然图像'),(46,'11','测试数据集','数值数据集','1级','23','有','./任务1/数值数据集/测试数据集/','32','任务1');
...
INSERT INTO `datatable` VALUES (84,'数值数据集','任务1','33','loss.csv',4,56,'float','数值数据集/任务1/33/loss.csv','1723109845680'),(85,'图像数据集','自然图像','45','车辆检测数据',300000,1024,'jpg','图像数据集/自然图像/45/loss.csv','1723111228220'),(86,'数值数据集','任务1','33','loss2.csv',4,16,'float','数值数据集/任务1/33/loss2.csv','1724251690873'),(87,'数值数据集','任务1','42','loss.csv',4,56,'float','数值数据集/任务1/42/loss.csv','1724251725804'),(88,'数值数据集','任务1','33','loss3.csv',4,16,'float','数值数据集/任务1/33/loss3.csv','1724251972045');
...
INSERT INTO `example` VALUES (56,'小样本','2级','运行中','领域1','A领域','123','23213','动作分布','string',0,0,'',0,'',0,0,1727096927328,0,0,0,10),(57,'大样本','1级','运行中','领域1','A领域','22','回归','','string',0,0,'',0,'',0,0,1727096986638,0,0,0,11),(63,'测试','1级','运行中','领域1','A领域','','','','string',0,0,'',0,'',0,0,1727101773068,0,0,0,12);
...
INSERT INTO `modelbase` VALUES (17,'1','强化学习','2级','python','强化学习/值迭代/17/2.png','无','无','值迭代','11',''),(20,'1233333','深度学习','1级','python','','123','2323','卷积神经网络','11',''),(21,'23213','机器学习','2级','python','','312312','3123123','分类','11',''),(22,'逻辑回归','机器学习','1级','python','','1','1','回归','11',''),(23,'岭回归','机器学习','1级','python','','1','1','回归','11','');
...
INSERT INTO `user` VALUES (1,'ss','123456'),(2,'123','1234'),(4,'22222','1234'),(5,'username','password'),(6,'sss','123456'),(7,'sk','111'),(8,'sssss','111111'),(9,'456156','123456');
